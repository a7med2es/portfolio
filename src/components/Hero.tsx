        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="space-y-2 mb-6">
              <p className="text-xl text-blue-200 font-medium">CONTROL & SYSTEMS ENGINEER | INDUSTRIAL AUTOMATION</p>
              <p className="text-lg text-slate-300">EMBEDDED & SMART SYSTEMS | EMERGING TECHNOLOGIES</p>
            </div>
